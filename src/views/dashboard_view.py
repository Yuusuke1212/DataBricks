...
class DashboardView(QWidget):
    ...
    def _create_last_sync_card(self, grid_layout, row: int, col: int):
        ...
        # 同期ボタン
        self.sync_button = PushButton("同期実行")
        self.sync_button.setIcon(FIF.SYNC.icon())  # .icon()メソッドを使用
        self.sync_button.clicked.connect(self._refresh_sync_info)  # 正しいメソッド名に修正
    ...
    def _create_quick_actions_card(self, grid_layout, row: int, col: int):
        ...
        self.diff_data_btn.setIcon(FIF.DOWNLOAD.icon())  # .icon()メソッドを使用
        ...
        self.week_data_btn.setIcon(FIF.CALENDAR.icon())  # .icon()メソッドを使用
        ...
        # エクスポートボタン
        self.export_btn = PushButton("データエクスポート")
        self.export_btn.setIcon(FIF.SHARE.icon())  # .icon()メソッドを使用
    ...
    def _create_activity_log_card(self, grid_layout, row: int, col: int):
        ...
        self.detail_log_btn.setIcon(FIF.DOCUMENT.icon())  # .icon()メソッドを使用
        self.detail_log_btn.clicked.connect(self._show_detail_log)  # 正しいメソッド名に修正
