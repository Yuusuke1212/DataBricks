...
class ThemeManager(QObject):
    ...
    def generate_stylesheet(self, widget_class: str = "") -> str:
        ...
        # ★修正★: テーマ値の型安全なアクセス
        try:
            theme_name = self._current_theme.value if hasattr(self._current_theme, 'value') else str(self._current_theme)
        except (AttributeError, TypeError):
            theme_name = 'LIGHT'
        
        return f"""
        /* JRA-Data Collector Custom Styling - {theme_name} Theme */
